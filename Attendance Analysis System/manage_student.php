...
<div class="container-fluid">
    <form action="" id="manage-student">
        ...
        <div class="form-group">
            <label for="" class="control-label">Enrollment</label>
            <input type="number" class="form-control" name="id_no" min="12" max="12"  value="<?php echo isset($id_no) ? $id_no :'' ?>" autocomplete="OFF" required>
        </div>
        <div class="form-group">
            <label for="" class="control-label">Name</label>
            <input type="text" class="form-control" name="name"  value="<?php echo isset($name) ? $name :'' ?>" autocomplete="OFF" required>
        </div>
        <div class="form-group">
